...
public class HudolinShortVariant extends ConsoleVariantSchema {
    public static final Identifier REFERENCE = AITMod.id("console/hudolin_short");

    public HudolinShortVariant() {
