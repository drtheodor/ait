...
public class BlueBoxVariant extends ExteriorVariantSchema {
    ...
    public static final Identifier REFERENCE = AITMod.id("exterior/exclusive/blue_box");

    protected BlueBoxVariant(String variant) {
        super(ExclusiveCategory.REFERENCE, REFERENCE.withSuffixedPath("/" + variant));
    }

    public BlueBoxVariant() {
        this("default");
    }
    ...
    public DoorSchema door() {
        return DoorRegistry.REGISTRY.get(BlueBoxDoorVariant.REFERENCE);
    }
