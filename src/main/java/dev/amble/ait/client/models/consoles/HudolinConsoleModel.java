...
public class HudolinConsoleModel extends ConsoleModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData cube_r12 = console.addChild("cube_r12", ModelPartBuilder.create().uv(0, 7).cuboid(-2.5F, -4.5F, -3.6699F, 5.0F, 6.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.0311F, 0.6603F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData cube_r19 = console.addChild("cube_r19", ModelPartBuilder.create().uv(0, 40).mirrored().cuboid(-2.5F, -23.5F, -3.6699F, 5.0F, 25.0F, 0.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -23.0311F, 0.6603F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData cube_r22 = console.addChild("cube_r22", ModelPartBuilder.create().uv(17, 0).cuboid(0.6314F, -1.6314F, -5.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -5.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(17, 0).mirrored().cuboid(-1.6314F, 0.6314F, -5.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -2.5311F, 0.0F, -2.2555F, -0.6591F, 2.0344F));

        ModelPartData cube_r23 = console.addChild("cube_r23", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-1.6314F, -1.6314F, 4.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(17, 0).cuboid(-0.5F, -0.5F, 4.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(0.6314F, 0.6314F, 4.0301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.5311F, 0.0F, 2.2555F, -0.6591F, -2.0344F));

        ModelPartData cube_r24 = console.addChild("cube_r24", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-1.6F, -2.5311F, 4.5301F, 0.0F, 0.0F, -0.7854F));

        ModelPartData cube_r25 = console.addChild("cube_r25", ModelPartBuilder.create().uv(17, 0).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.5311F, 4.5301F, 0.0F, 0.0F, -0.7854F));
        ...
        ModelPartData cube_r27 = console.addChild("cube_r27", ModelPartBuilder.create().uv(17, 0).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.6F, -2.5311F, -4.5301F, 0.0F, 0.0F, 0.7854F));

        ModelPartData cube_r28 = console.addChild("cube_r28", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -2.5311F, -4.5301F, 0.0F, 0.0F, 0.7854F));

        ModelPartData cube_r29 = console.addChild("cube_r29", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-1.6F, -2.5311F, -4.5301F, 0.0F, 0.0F, 0.7854F));

        ModelPartData cube_r30 = console.addChild("cube_r30", ModelPartBuilder.create().uv(0, 3).mirrored().cuboid(-2.5F, -1.5F, -4.3301F, 5.0F, 3.0F, 1.0F, new Dilation(0.27F)).mirrored(false), ModelTransform.of(-0.1712F, -1.7311F, -0.0988F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r31 = console.addChild("cube_r31", ModelPartBuilder.create().uv(0, 3).cuboid(-2.5F, -1.5F, -4.3301F, 5.0F, 3.0F, 1.0F, new Dilation(0.27F))
        ...
        ModelPartData cube_r32 = console.addChild("cube_r32", ModelPartBuilder.create().uv(0, 3).mirrored().cuboid(-2.5F, -1.5F, -4.3301F, 5.0F, 3.0F, 1.0F, new Dilation(0.27F)).mirrored(false)
        ...
        ModelPartData cube_r33 = console.addChild("cube_r33", ModelPartBuilder.create().uv(0, 3).cuboid(-2.5F, -1.5F, -0.5F, 5.0F, 3.0F, 1.0F, new Dilation(0.27F)), ModelTransform.of(0.0F, -1.7311F, 4.0278F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r34 = console.addChild("cube_r34", ModelPartBuilder.create().uv(0, 3).cuboid(-2.5F, -1.5F, -4.3301F, 5.0F, 3.0F, 1.0F, new Dilation(0.27F)), ModelTransform.of(0.1712F, -1.7311F, -0.0988F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r35 = console.addChild("cube_r35", ModelPartBuilder.create().uv(0, 3).mirrored().cuboid(-1.628F, -1.5F, -5.0313F, 5.0F, 3.0F, 1.0F, new Dilation(0.271F)).mirrored(false), ModelTransform.of(0.0F, -19.7311F, 1.007F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r36 = console.addChild("cube_r36", ModelPartBuilder.create().uv(0, 3).cuboid(-2.5F, -1.5F, -3.5208F, 5.0F, 3.0F, 1.0F, new Dilation(0.271F)), ModelTransform.of(0.0F, -19.7311F, 1.007F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r37 = console.addChild("cube_r37", ModelPartBuilder.create().uv(76, 5).cuboid(-5.372F, -1.7F, -5.0313F, 9.0F, 0.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(-0.8901F, -19.7311F, 1.5208F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r38 = console.addChild("cube_r38", ModelPartBuilder.create().uv(0, 3).cuboid(-3.372F, -1.5F, -5.0313F, 5.0F, 3.0F, 1.0F, new Dilation(0.271F)), ModelTransform.of(0.0F, -19.7311F, 1.007F, 0.0F, -1.0472F, 0.0F));
        ...
        ModelPartData cube_r41 = console.addChild("cube_r41", ModelPartBuilder.create().uv(17, 0).cuboid(0.7728F, -1.7728F, -5.1301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r42 = console.addChild("cube_r42", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -5.1301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(17, 0).mirrored().cuboid(-1.7728F, -1.7728F, -5.1301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(17, 0).mirrored().cuboid(-1.7728F, -1.7728F, 4.1301F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r44 = console.addChild("cube_r44", ModelPartBuilder.create().uv(17, 0).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r45 = console.addChild("cube_r45", ModelPartBuilder.create().uv(17, 0).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r46 = console.addChild("cube_r46", ModelPartBuilder.create().uv(50, 0).mirrored().cuboid(-3.0F, -2.0F, -5.5F, 6.0F, 4.0F, 5.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r48 = console.addChild("cube_r48", ModelPartBuilder.create().uv(50, 0).cuboid(-3.0F, -2.0F, -5.5F, 6.0F, 4.0F, 5.0F, new Dilation(0.0F))
                .uv(0, 23).cuboid(-3.0F, 9.5F, -5.5F, 6.0F, 2.0F, 5.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r49 = console.addChild("cube_r49", ModelPartBuilder.create().uv(50, 0).mirrored().cuboid(-3.0F, -2.0F, -5.5F, 6.0F, 4.0F, 5.0F, new Dilation(0.0F)).mirrored(false)
                .uv(0, 23).mirrored().cuboid(-3.0F, 9.5F, -5.5F, 6.0F, 2.0F, 5.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r50 = console.addChild("cube_r50", ModelPartBuilder.create().uv(50, 0).cuboid(-3.0F, -2.0F, -2.5F, 6.0F, 4.0F, 5.0F, new Dilation(0.0F))
                .uv(0, 23).cuboid(-3.0F, 9.5F, -2.5F, 6.0F, 2.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -11.1311F, 2.6961F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r51 = console.addChild("cube_r51", ModelPartBuilder.create().uv(4, 30).cuboid(-4.2712F, -0.5F, -6.5075F, 7.0F, 1.0F, 5.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -0.1311F, -0.8905F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r52 = console.addChild("cube_r52", ModelPartBuilder.create().uv(4, 30).cuboid(-4.0F, 1.0F, -5.5F, 7.0F, 1.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(0.7369F, -1.6311F, 0.1519F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r53 = console.addChild("cube_r53", ModelPartBuilder.create().uv(4, 30).cuboid(-2.7288F, -0.5F, -6.5075F, 7.0F, 1.0F, 5.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -0.1311F, -0.8905F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r54 = console.addChild("cube_r54", ModelPartBuilder.create().uv(4, 30).mirrored().cuboid(-4.0F, 1.0F, -5.5F, 7.0F, 1.0F, 5.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-0.2369F, -1.6311F, -0.7141F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r55 = console.addChild("cube_r55", ModelPartBuilder.create().uv(79, 29).cuboid(-2.0F, -2.9926F, -5.488F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r56 = console.addChild("cube_r56", ModelPartBuilder.create().uv(49, 83).cuboid(2.6F, -0.6F, -1.0F, 2.0F, 1.0F, 2.0F, new Dilation(-0.1F))
        ...
        ModelPartData cube_r57 = console.addChild("cube_r57", ModelPartBuilder.create().uv(43, 70).cuboid(-4.0F, -3.6926F, -12.588F, 6.0F, 1.0F, 4.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r58 = console.addChild("cube_r58", ModelPartBuilder.create().uv(54, 21).mirrored().cuboid(-4.0F, -3.7926F, -7.488F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r59 = console.addChild("cube_r59", ModelPartBuilder.create().uv(20, 22).cuboid(0.4F, -0.1F, -1.4F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r60 = console.addChild("cube_r60", ModelPartBuilder.create().uv(18, 53).cuboid(-0.44F, 0.1F, -1.9F, 1.0F, 0.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(7.2421F, -16.6864F, 5.6823F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData cube_r61 = console.addChild("cube_r61", ModelPartBuilder.create().uv(18, 53).cuboid(-0.35F, 0.1F, -1.9F, 1.0F, 0.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(8.8921F, -16.6864F, 2.8244F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData cube_r62 = console.addChild("cube_r62", ModelPartBuilder.create().uv(18, 53).cuboid(-0.575F, 0.1F, -1.9F, 1.0F, 0.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(7.9796F, -16.6864F, 4.4049F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData cube_r63 = console.addChild("cube_r63", ModelPartBuilder.create().uv(20, 4).mirrored().cuboid(-0.5F, 0.0F, 1.2F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r64 = console.addChild("cube_r64", ModelPartBuilder.create().uv(21, 17).mirrored().cuboid(-0.5F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(11.3416F, -14.0761F, 5.9707F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData cube_r65 = console.addChild("cube_r65", ModelPartBuilder.create().uv(21, 17).cuboid(0.5F, -1.0F, 0.25F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r66 = console.addChild("cube_r66", ModelPartBuilder.create().uv(21, 17).cuboid(-0.5F, 0.0F, -1.0F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(11.8534F, -13.3591F, 7.1322F, -0.6109F, 1.0472F, 0.0F));

        ModelPartData cube_r67 = console.addChild("cube_r67", ModelPartBuilder.create().uv(57, 52).cuboid(-1.5F, -1.0F, -5.8F, 6.0F, 2.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r68 = console.addChild("cube_r68", ModelPartBuilder.create().uv(12, 14).cuboid(-4.0F, 0.5F, -1.5F, 0.0F, 1.0F, 2.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r69 = console.addChild("cube_r69", ModelPartBuilder.create().uv(15, 39).cuboid(-2.5F, -0.5F, 2.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.2F))
        ...
        ModelPartData cube_r70 = console.addChild("cube_r70", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.6204F, 8.3021F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r71 = console.addChild("cube_r71", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.0469F, 9.1212F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r72 = console.addChild("cube_r72", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.4733F, 9.9404F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r73 = console.addChild("cube_r73", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.8997F, 10.7595F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r74 = console.addChild("cube_r74", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.3261F, 11.5787F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r75 = console.addChild("cube_r75", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -14.179F, 13.217F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r76 = console.addChild("cube_r76", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -14.7525F, 12.3978F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r77 = console.addChild("cube_r77", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.3261F, 11.5787F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r78 = console.addChild("cube_r78", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.8997F, 10.7595F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r79 = console.addChild("cube_r79", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.4733F, 9.9404F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r80 = console.addChild("cube_r80", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.0469F, 9.1212F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r81 = console.addChild("cube_r81", ModelPartBuilder.create().uv(22, 38).cuboid(0.0F, 0.0F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.6204F, 8.3021F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r82 = console.addChild("cube_r82", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -14.7525F, 12.3978F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r83 = console.addChild("cube_r83", ModelPartBuilder.create().uv(22, 36).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -14.179F, 13.217F, -1.5708F, -0.9599F, 1.5708F));

        ModelPartData cube_r84 = console.addChild("cube_r84", ModelPartBuilder.create().uv(62, 45).cuboid(3.5F, -0.2F, -1.5F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -15.1295F, 11.6852F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData cube_r85 = console.addChild("cube_r85", ModelPartBuilder.create().uv(57, 57).cuboid(-6.0F, 0.2F, -2.0F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r86 = console.addChild("cube_r86", ModelPartBuilder.create().uv(61, 49).cuboid(-10.0F, -1.0F, -19.0526F, 21.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, -11.1F, 0.0F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r87 = console.addChild("cube_r87", ModelPartBuilder.create().uv(61, 49).cuboid(-10.0F, -1.0F, -19.0526F, 21.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.5F, -11.1F, -0.866F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r88 = console.addChild("cube_r88", ModelPartBuilder.create().uv(61, 49).cuboid(-10.0F, -1.0F, -19.0526F, 21.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -11.1F, 0.0F, -3.1416F, 1.0472F, -3.1416F));

        ModelPartData cube_r89 = console.addChild("cube_r89", ModelPartBuilder.create().uv(61, 49).cuboid(-10.0F, -1.0F, -19.0526F, 21.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, -11.1F, -0.866F, -3.1416F, 0.0F, 3.1416F));

        ModelPartData cube_r90 = console.addChild("cube_r90", ModelPartBuilder.create().uv(61, 49).cuboid(-10.0F, -1.0F, -19.0526F, 21.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, -11.1F, 0.866F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r91 = console.addChild("cube_r91", ModelPartBuilder.create().uv(21, 29).cuboid(-11.0F, -0.5F, -16.0394F, 22.0F, 1.0F, 14.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -12.5F, 3.0131F, -3.1416F, 0.0F, 3.1416F));

        ModelPartData cube_r92 = console.addChild("cube_r92", ModelPartBuilder.create().uv(21, 29).cuboid(-18.817F, -1.0F, -5.5131F, 22.0F, 1.0F, 14.0F, new Dilation(0.0F)), ModelTransform.of(7.817F, -12.0F, 13.5394F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r93 = console.addChild("cube_r93", ModelPartBuilder.create().uv(21, 29).cuboid(-13.6095F, -0.5F, -20.5591F, 22.0F, 1.0F, 14.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -12.5F, 3.0131F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r94 = console.addChild("cube_r94", ModelPartBuilder.create().uv(21, 29).cuboid(-3.183F, -1.0F, -5.5131F, 22.0F, 1.0F, 14.0F, new Dilation(0.0F)), ModelTransform.of(-7.817F, -12.0F, 13.5394F, -3.1416F, 1.0472F, -3.1416F));

        ModelPartData cube_r95 = console.addChild("cube_r95", ModelPartBuilder.create().uv(21, 29).cuboid(-8.3905F, -0.5F, -20.5591F, 22.0F, 1.0F, 14.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -12.5F, 3.0131F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r96 = console.addChild("cube_r96", ModelPartBuilder.create().uv(27, 44).cuboid(-1.5F, -0.7F, -1.5F, 4.0F, 0.0F, 3.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r97 = console.addChild("cube_r97", ModelPartBuilder.create().uv(0, 13).cuboid(-2.0489F, -0.1101F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 0.1309F));

        ModelPartData cube_r98 = console.addChild("cube_r98", ModelPartBuilder.create().uv(10, 7).cuboid(-1.2654F, 0.6152F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 1.0908F));

        ModelPartData cube_r99 = console.addChild("cube_r99", ModelPartBuilder.create().uv(10, 8).cuboid(-0.6837F, 0.2297F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 1.7017F));

        ModelPartData cube_r100 = console.addChild("cube_r100", ModelPartBuilder.create().uv(11, 2).cuboid(-0.7049F, -0.7436F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 1.6144F));

        ModelPartData cube_r101 = console.addChild("cube_r101", ModelPartBuilder.create().uv(10, 11).cuboid(-1.689F, -1.5863F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 2.5744F));

        ModelPartData cube_r102 = console.addChild("cube_r102", ModelPartBuilder.create().uv(13, 0).cuboid(-0.8491F, -1.5734F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -17.5526F, 0.0F, 0.0F, 1.8326F));

        ModelPartData cube_r103 = console.addChild("cube_r103", ModelPartBuilder.create().uv(0, 13).cuboid(-2.0489F, -0.1101F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, -3.1416F, 0.0F, 3.0107F));

        ModelPartData cube_r104 = console.addChild("cube_r104", ModelPartBuilder.create().uv(10, 7).cuboid(-1.2654F, 0.6152F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, -3.1416F, 0.0F, 2.0508F));

        ModelPartData cube_r105 = console.addChild("cube_r105", ModelPartBuilder.create().uv(10, 8).cuboid(-0.6837F, 0.2297F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, -3.1416F, 0.0F, 1.4399F));

        ModelPartData cube_r106 = console.addChild("cube_r106", ModelPartBuilder.create().uv(11, 2).cuboid(-0.7049F, -0.7436F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, 3.1416F, 0.0F, 1.5272F));

        ModelPartData cube_r107 = console.addChild("cube_r107", ModelPartBuilder.create().uv(10, 11).cuboid(-1.689F, -1.5863F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, -3.1416F, 0.0F, 0.5672F));

        ModelPartData cube_r108 = console.addChild("cube_r108", ModelPartBuilder.create().uv(13, 0).cuboid(-0.8491F, -1.5734F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.3865F, -15.1844F, -16.5526F, -3.1416F, 0.0F, 1.309F));

        ModelPartData cube_r109 = console.addChild("cube_r109", ModelPartBuilder.create().uv(10, 11).cuboid(-0.5F, -2.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(3.8984F, -16.5938F, -15.5526F, 0.0F, 0.0F, 2.5744F));

        ModelPartData cube_r110 = console.addChild("cube_r110", ModelPartBuilder.create().uv(13, 0).cuboid(-0.5F, -2.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.5818F, -15.7615F, -15.5526F, 0.0F, 0.0F, 1.8326F));

        ModelPartData cube_r111 = console.addChild("cube_r111", ModelPartBuilder.create().uv(11, 2).cuboid(-0.5F, -1.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.6398F, -15.4221F, -15.5526F, 0.0F, 0.0F, 1.6144F));

        ModelPartData cube_r112 = console.addChild("cube_r112", ModelPartBuilder.create().uv(10, 8).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.687F, -15.4618F, -15.5526F, 0.0F, 0.0F, 1.7017F));

        ModelPartData cube_r113 = console.addChild("cube_r113", ModelPartBuilder.create().uv(10, 7).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.0439F, -15.3483F, -15.5526F, 0.0F, 0.0F, 1.0908F));

        ModelPartData cube_r114 = console.addChild("cube_r114", ModelPartBuilder.create().uv(0, 13).cuboid(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.8F, -15.0F, -15.5526F, 0.0F, 0.0F, 0.1309F));
        ...
        ModelPartData cube_r115 = lighton13.addChild("cube_r115", ModelPartBuilder.create().uv(9, 14).cuboid(-1.5F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData off18 = lighton13.addChild("off18", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r116 = off18.addChild("cube_r116", ModelPartBuilder.create().uv(22, 71).cuboid(-1.5F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData lighton15 = console.addChild("lighton15", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r117 = lighton15.addChild("cube_r117", ModelPartBuilder.create().uv(15, 39).cuboid(-1.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData off20 = lighton15.addChild("off20", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r118 = off20.addChild("cube_r118", ModelPartBuilder.create().uv(38, 71).cuboid(-1.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData lighton16 = console.addChild("lighton16", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r119 = lighton16.addChild("cube_r119", ModelPartBuilder.create().uv(9, 14).cuboid(-0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData off21 = lighton16.addChild("off21", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r120 = off21.addChild("cube_r120", ModelPartBuilder.create().uv(22, 71).cuboid(-0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData lighton17 = console.addChild("lighton17", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r121 = lighton17.addChild("cube_r121", ModelPartBuilder.create().uv(15, 39).cuboid(0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData off22 = lighton17.addChild("off22", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r122 = off22.addChild("cube_r122", ModelPartBuilder.create().uv(38, 71).cuboid(0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData lighton14 = console.addChild("lighton14", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r123 = lighton14.addChild("cube_r123", ModelPartBuilder.create().uv(51, 0).cuboid(-0.1F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData off19 = lighton14.addChild("off19", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r124 = off19.addChild("cube_r124", ModelPartBuilder.create().uv(26, 71).cuboid(-0.1F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, -3.1416F));

        ModelPartData lighton9 = console.addChild("lighton9", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r125 = lighton9.addChild("cube_r125", ModelPartBuilder.create().uv(51, 0).cuboid(0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData off14 = lighton9.addChild("off14", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r126 = off14.addChild("cube_r126", ModelPartBuilder.create().uv(26, 71).cuboid(0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData lighton10 = console.addChild("lighton10", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r127 = lighton10.addChild("cube_r127", ModelPartBuilder.create().uv(9, 14).cuboid(0.5F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData off15 = lighton10.addChild("off15", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r128 = off15.addChild("cube_r128", ModelPartBuilder.create().uv(22, 71).cuboid(0.5F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData lightson = console.addChild("lightson", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r129 = lightson.addChild("cube_r129", ModelPartBuilder.create().uv(51, 0).cuboid(-0.9F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData off13 = lightson.addChild("off13", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r130 = off13.addChild("cube_r130", ModelPartBuilder.create().uv(26, 71).cuboid(-0.9F, -0.4F, 2.1F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData lighton11 = console.addChild("lighton11", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r131 = lighton11.addChild("cube_r131", ModelPartBuilder.create().uv(15, 39).cuboid(-0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData off16 = lighton11.addChild("off16", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r132 = off16.addChild("cube_r132", ModelPartBuilder.create().uv(38, 71).cuboid(-0.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData lighton12 = console.addChild("lighton12", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, -15.4164F, 11.0549F));

        ModelPartData cube_r133 = lighton12.addChild("cube_r133", ModelPartBuilder.create().uv(9, 14).cuboid(-1.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));

        ModelPartData off17 = lighton12.addChild("off17", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r134 = off17.addChild("cube_r134", ModelPartBuilder.create().uv(22, 71).cuboid(-1.5F, -0.4F, 0.6F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 0.0F, 3.1416F));
        ...
        ModelPartData cube_r135 = pannel3.addChild("cube_r135", ModelPartBuilder.create().uv(45, 50).cuboid(2.4F, 0.7409F, -2.5917F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F))
        ...
        ModelPartData cube_r136 = lighton4.addChild("cube_r136", ModelPartBuilder.create().uv(9, 14).cuboid(-0.5F, -1.1F, -0.3F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off5 = lighton4.addChild("off5", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r137 = off5.addChild("cube_r137", ModelPartBuilder.create().uv(22, 71).cuboid(-0.5F, -1.1F, -0.3F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData lighton5 = console.addChild("lighton5", ModelPartBuilder.create(), ModelTransform.pivot(7.2142F, -14.3594F, 10.285F));

        ModelPartData cube_r138 = lighton5.addChild("cube_r138", ModelPartBuilder.create().uv(15, 39).cuboid(-0.5F, -1.1F, -1.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off6 = lighton5.addChild("off6", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r139 = off6.addChild("cube_r139", ModelPartBuilder.create().uv(38, 71).cuboid(-0.5F, -1.1F, -1.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData lighton6 = console.addChild("lighton6", ModelPartBuilder.create(), ModelTransform.pivot(7.2142F, -14.3594F, 10.285F));

        ModelPartData cube_r140 = lighton6.addChild("cube_r140", ModelPartBuilder.create().uv(51, 0).cuboid(-0.5F, -1.1F, -2.7F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off7 = lighton6.addChild("off7", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r141 = off7.addChild("cube_r141", ModelPartBuilder.create().uv(26, 71).cuboid(-0.5F, -1.1F, -2.7F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r142 = brightlighton3.addChild("cube_r142", ModelPartBuilder.create().uv(14, 36).cuboid(1.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off10 = brightlighton3.addChild("off10", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r143 = off10.addChild("cube_r143", ModelPartBuilder.create().uv(10, 36).cuboid(1.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r144 = brightlighton2.addChild("cube_r144", ModelPartBuilder.create().uv(14, 36).cuboid(-0.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off9 = brightlighton2.addChild("off9", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r145 = off9.addChild("cube_r145", ModelPartBuilder.create().uv(10, 36).cuboid(-0.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r146 = brightlighton.addChild("cube_r146", ModelPartBuilder.create().uv(14, 36).cuboid(-2.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));

        ModelPartData off8 = brightlighton.addChild("off8", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r147 = off8.addChild("cube_r147", ModelPartBuilder.create().uv(10, 36).cuboid(-2.5F, -0.6F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r148 = spin3.addChild("cube_r148", ModelPartBuilder.create().uv(18, 57).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-0.0248F, -0.091F, 0.0143F, 0.0F, -0.7418F, 0.0F));
        ...
        ModelPartData cube_r149 = blinkingon.addChild("cube_r149", ModelPartBuilder.create().uv(18, 53).cuboid(-1.5F, -4.3926F, -7.488F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 1.0472F, 3.1416F));

        ModelPartData blinkingoff = blinkingon.addChild("blinkingoff", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r150 = blinkingoff.addChild("cube_r150", ModelPartBuilder.create().uv(39, 15).cuboid(-1.5F, -4.3926F, -7.488F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -2.5307F, 1.0472F, 3.1416F));

        ModelPartData lighton7 = console.addChild("lighton7", ModelPartBuilder.create(), ModelTransform.pivot(-10.8219F, -14.1954F, -6.248F));

        ModelPartData cube_r151 = lighton7.addChild("cube_r151", ModelPartBuilder.create().uv(9, 14).cuboid(-5.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));

        ModelPartData off11 = lighton7.addChild("off11", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r152 = off11.addChild("cube_r152", ModelPartBuilder.create().uv(22, 71).cuboid(-5.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));

        ModelPartData lighton8 = console.addChild("lighton8", ModelPartBuilder.create(), ModelTransform.pivot(-10.8219F, -14.1954F, -6.248F));

        ModelPartData cube_r153 = lighton8.addChild("cube_r153", ModelPartBuilder.create().uv(9, 14).cuboid(4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));

        ModelPartData off12 = lighton8.addChild("off12", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r154 = off12.addChild("cube_r154", ModelPartBuilder.create().uv(22, 71).cuboid(4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.09F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));

        ModelPartData lighton18 = console.addChild("lighton18", ModelPartBuilder.create(), ModelTransform.pivot(-5.7142F, -18.3252F, -3.2991F));

        ModelPartData cube_r155 = lighton18.addChild("cube_r155", ModelPartBuilder.create().uv(51, 0).cuboid(-0.5F, -0.4F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.15F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));

        ModelPartData off23 = lighton18.addChild("off23", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r156 = off23.addChild("cube_r156", ModelPartBuilder.create().uv(26, 71).cuboid(-0.5F, -0.4F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.14F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 1.0472F, 0.0F));
        ...
        ModelPartData cube_r157 = dividers.addChild("cube_r157", ModelPartBuilder.create().uv(54, 62).mirrored().cuboid(-0.5F, -6.3198F, 2.6353F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.2351F, 0.0F, 2.5744F, 0.0F, -3.1416F));

        ModelPartData cube_r158 = dividers.addChild("cube_r158", ModelPartBuilder.create().uv(54, 62).cuboid(-0.5F, -1.0F, -6.5F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.6567F, 10.563F, -0.5672F, 0.0F, 0.0F));

        ModelPartData cube_r159 = dividers.addChild("cube_r159", ModelPartBuilder.create().uv(54, 62).mirrored().cuboid(-0.5F, -6.3198F, 2.6353F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.2351F, 0.0F, 2.5744F, -1.0472F, -3.1416F));

        ModelPartData cube_r160 = dividers.addChild("cube_r160", ModelPartBuilder.create().uv(54, 62).cuboid(-0.5F, -1.0F, -6.5F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)), ModelTransform.of(9.1478F, 0.6567F, 5.2815F, -0.5672F, 1.0472F, 0.0F));

        ModelPartData cube_r161 = dividers.addChild("cube_r161", ModelPartBuilder.create().uv(54, 62).cuboid(-0.5F, -1.0F, -6.5F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)), ModelTransform.of(9.1478F, 0.6567F, -5.2815F, 2.5744F, 1.0472F, -3.1416F));

        ModelPartData cube_r162 = dividers.addChild("cube_r162", ModelPartBuilder.create().uv(54, 62).mirrored().cuboid(-0.5F, -0.2F, -6.0F, 1.0F, 2.0F, 13.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-9.1549F, -0.2866F, 5.2856F, -0.5672F, -1.0472F, 0.0F));

        ModelPartData slide2 = console.addChild("slide2", ModelPartBuilder.create(), ModelTransform.pivot(-2.8F, -15.7237F, -9.9648F));

        ModelPartData cube_r163 = slide2.addChild("cube_r163", ModelPartBuilder.create().uv(16, 3).cuboid(0.2F, -0.2F, -0.25F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(-0.7F, -0.1023F, -0.3769F, 0.6109F, 0.0F, 0.0F));

        ModelPartData slide = console.addChild("slide", ModelPartBuilder.create(), ModelTransform.pivot(-4.5F, -15.1501F, -10.784F));

        ModelPartData cube_r164 = slide.addChild("cube_r164", ModelPartBuilder.create().uv(0, 26).cuboid(-1.5F, -0.2F, -1.25F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(1.0F, -0.6759F, 0.4423F, 0.6109F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r165 = handbreak.addChild("cube_r165", ModelPartBuilder.create().uv(30, 17).cuboid(-0.25F, 0.3681F, -0.3228F, 1.0F, 0.0F, 2.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r166 = handbreak.addChild("cube_r166", ModelPartBuilder.create().uv(30, 17).cuboid(0.25F, -0.6319F, -0.5228F, 0.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, 0.3598F, -0.923F, 1.4399F, 0.0F, 0.0F));

        ModelPartData cube_r167 = handbreak.addChild("cube_r167", ModelPartBuilder.create().uv(26, 23).cuboid(-0.45F, -1.6653F, -0.5876F, 1.0F, 2.0F, 1.0F, new Dilation(-0.15F))
        ...
        ModelPartData cube_r168 = flightlighton.addChild("cube_r168", ModelPartBuilder.create().uv(9, 14).cuboid(-0.5F, -0.5F, -0.2F, 1.0F, 1.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData off = flightlighton.addChild("off", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r169 = off.addChild("cube_r169", ModelPartBuilder.create().uv(22, 71).cuboid(-0.5F, -0.5F, -0.2F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r170 = thing10.addChild("cube_r170", ModelPartBuilder.create().uv(36, 3).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData thing9 = fix30.addChild("thing9", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, 0.0F, 0.0F));

        ModelPartData cube_r171 = thing9.addChild("cube_r171", ModelPartBuilder.create().uv(41, 1).cuboid(2.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(-3.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData thing8 = fix30.addChild("thing8", ModelPartBuilder.create(), ModelTransform.pivot(4.5F, 0.0F, 0.0F));

        ModelPartData cube_r172 = thing8.addChild("cube_r172", ModelPartBuilder.create().uv(41, 1).cuboid(4.0F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(-4.5F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData thing7 = fix30.addChild("thing7", ModelPartBuilder.create(), ModelTransform.pivot(6.0F, 0.0F, 0.0F));

        ModelPartData cube_r173 = thing7.addChild("cube_r173", ModelPartBuilder.create().uv(41, 1).cuboid(5.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(-6.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData thing6 = fix30.addChild("thing6", ModelPartBuilder.create(), ModelTransform.pivot(8.5F, 0.0F, 0.0F));

        ModelPartData cube_r174 = thing6.addChild("cube_r174", ModelPartBuilder.create().uv(44, 0).cuboid(7.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(-8.5F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r175 = dial7.addChild("cube_r175", ModelPartBuilder.create().uv(33, 4).cuboid(0.0F, -0.5F, -0.5F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r176 = bottom.addChild("cube_r176", ModelPartBuilder.create().uv(43, 77).cuboid(-2.5F, -8.0F, 0.5F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.083F, 3.819F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r177 = bottom.addChild("cube_r177", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 1.1829F, -3.0484F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r178 = bottom.addChild("cube_r178", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0634F, 1.1829F, 0.0255F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r179 = bottom.addChild("cube_r179", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(2.6304F, 1.1829F, -1.5298F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r180 = bottom.addChild("cube_r180", ModelPartBuilder.create().uv(10, 63).cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.0634F, 1.1829F, 0.0255F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r181 = bottom.addChild("cube_r181", ModelPartBuilder.create().uv(10, 63).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-2.6304F, 1.1829F, -1.5298F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r182 = bottom.addChild("cube_r182", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -1.5708F, 0.0F));

        ModelPartData cube_r183 = bottom.addChild("cube_r183", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -0.7854F, 0.0F));

        ModelPartData cube_r184 = bottom.addChild("cube_r184", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 0.7854F, 0.0F));

        ModelPartData cube_r185 = bottom.addChild("cube_r185", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 1.5708F, 0.0F));

        ModelPartData cube_r186 = bottom.addChild("cube_r186", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.7854F, 3.1416F));

        ModelPartData cube_r187 = bottom.addChild("cube_r187", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.0F, 3.1416F));
        ...
        ModelPartData cube_r189 = top2.addChild("cube_r189", ModelPartBuilder.create().uv(53, 67).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 0.5F, -3.0373F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r190 = top2.addChild("cube_r190", ModelPartBuilder.create().uv(53, 67).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(2.6304F, 0.5F, -1.5187F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r191 = top2.addChild("cube_r191", ModelPartBuilder.create().uv(53, 67).mirrored().cuboid(-2.0F, -0.4961F, 2.5373F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 0.4961F, 0.0F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r192 = top2.addChild("cube_r192", ModelPartBuilder.create().uv(53, 67).cuboid(-2.0F, -0.4961F, 2.5373F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.4961F, 0.0F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r193 = top2.addChild("cube_r193", ModelPartBuilder.create().uv(53, 67).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-2.6304F, 0.5F, -1.5187F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r194 = top2.addChild("cube_r194", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, -1.5708F, 3.1416F));

        ModelPartData cube_r195 = top2.addChild("cube_r195", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, -3.1416F, -0.7854F, 0.0F));

        ModelPartData cube_r196 = top2.addChild("cube_r196", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, -3.1416F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r198 = top2.addChild("cube_r198", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 1.5708F, -3.1416F));

        ModelPartData cube_r199 = top2.addChild("cube_r199", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 0.7854F, 3.1416F));

        ModelPartData cube_r200 = top2.addChild("cube_r200", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 3.1416F));
        ...
        ModelPartData cube_r202 = nature.addChild("cube_r202", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r203 = nature.addChild("cube_r203", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r204 = nature.addChild("cube_r204", ModelPartBuilder.create().uv(43, 93).cuboid(-2.5F, -8.0F, 0.5F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r206 = nature.addChild("cube_r206", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r207 = nature.addChild("cube_r207", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 1.1829F, -3.0484F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r208 = nature.addChild("cube_r208", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0634F, 1.1829F, 0.0255F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r209 = nature.addChild("cube_r209", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(2.6304F, 1.1829F, -1.5298F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r210 = nature.addChild("cube_r210", ModelPartBuilder.create().uv(7, 121).cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.0634F, 1.1829F, 0.0255F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r211 = nature.addChild("cube_r211", ModelPartBuilder.create().uv(7, 121).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-2.6304F, 1.1829F, -1.5298F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r212 = nature.addChild("cube_r212", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -1.5708F, 0.0F));

        ModelPartData cube_r213 = nature.addChild("cube_r213", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -0.7854F, 0.0F));

        ModelPartData cube_r214 = nature.addChild("cube_r214", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 0.7854F, 0.0F));

        ModelPartData cube_r215 = nature.addChild("cube_r215", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 1.5708F, 0.0F));

        ModelPartData cube_r216 = nature.addChild("cube_r216", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.7854F, 3.1416F));

        ModelPartData cube_r217 = nature.addChild("cube_r217", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.0F, 3.1416F));
        ...
        ModelPartData cube_r219 = inside.addChild("cube_r219", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 19.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r220 = inside.addChild("cube_r220", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 19.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r221 = inside.addChild("cube_r221", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -8.0F, -0.5F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 16.5F, 3.8301F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r222 = inside.addChild("cube_r222", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 19.0F, 0.0F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r223 = inside.addChild("cube_r223", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 19.0F, 0.0F, 0.0F, 1.0472F, 0.0F));
        ...
        ModelPartData cube_r224 = underdividers.addChild("cube_r224", ModelPartBuilder.create().uv(0, 23).mirrored().cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(8.0849F, 1.2922F, 4.6678F, 1.2654F, -1.0472F, 3.1416F));

        ModelPartData cube_r225 = underdividers.addChild("cube_r225", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-1.0F, 1.2562F, -3.0287F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(8.602F, 0.5234F, 4.9664F, 1.8762F, 1.0472F, 0.0F));

        ModelPartData cube_r226 = underdividers.addChild("cube_r226", ModelPartBuilder.create().uv(21, 0).mirrored().cuboid(-0.5F, -1.0522F, -0.8966F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(8.4618F, 1.8688F, 4.8854F, 1.7017F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r228 = underdividers.addChild("cube_r228", ModelPartBuilder.create().uv(0, 13).cuboid(-1.0F, 1.4066F, 0.5519F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.0234F, -9.9328F, -1.8762F, 0.0F, 0.0F));

        ModelPartData cube_r229 = underdividers.addChild("cube_r229", ModelPartBuilder.create().uv(0, 23).cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 1.2922F, -9.3356F, -1.8762F, 0.0F, 0.0F));

        ModelPartData cube_r230 = underdividers.addChild("cube_r230", ModelPartBuilder.create().uv(21, 0).cuboid(-0.5F, -1.1025F, -0.0372F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.0234F, -9.9328F, -1.4399F, 0.0F, 0.0F));

        ModelPartData cube_r231 = underdividers.addChild("cube_r231", ModelPartBuilder.create().uv(12, 2).cuboid(-0.5F, -4.3012F, -0.2325F, 1.0F, 4.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 1.2922F, -9.3356F, -1.0908F, 0.0F, 0.0F));

        ModelPartData cube_r232 = underdividers.addChild("cube_r232", ModelPartBuilder.create().uv(0, 13).cuboid(-1.0F, -0.0301F, -2.3954F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-9.8294F, 0.7406F, 5.675F, 1.8762F, -1.0472F, 0.0F));

        ModelPartData cube_r233 = underdividers.addChild("cube_r233", ModelPartBuilder.create().uv(0, 23).cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(-8.0849F, 1.2922F, 4.6678F, 1.2654F, 1.0472F, -3.1416F));

        ModelPartData cube_r234 = underdividers.addChild("cube_r234", ModelPartBuilder.create().uv(21, 0).cuboid(-0.5F, -1.0522F, -0.8966F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-8.4618F, 1.8688F, 4.8854F, 1.7017F, 1.0472F, -3.1416F));

        ModelPartData cube_r235 = underdividers.addChild("cube_r235", ModelPartBuilder.create().uv(12, 2).mirrored().cuboid(-0.5F, -4.3012F, -0.2325F, 1.0F, 4.0F, 1.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-8.0849F, 1.2922F, 4.6678F, 2.0508F, 1.0472F, -3.1416F));

        ModelPartData cube_r236 = underdividers.addChild("cube_r236", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.1358F, -0.3535F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-5.18F, -9.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r237 = underdividers.addChild("cube_r237", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -56.55F, 5.6278F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F))
        ...
        ModelPartData cube_r238 = underdividers.addChild("cube_r238", ModelPartBuilder.create().uv(22, 23).mirrored().cuboid(-0.5F, -2.05F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)).mirrored(false)
        ...
        ModelPartData cube_r239 = underdividers.addChild("cube_r239", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.0892F, -1.949F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(6.5616F, -9.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

        ModelPartData cube_r240 = underdividers.addChild("cube_r240", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -57.45F, 5.4301F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F))
        ...
        ModelPartData cube_r241 = underdividers.addChild("cube_r241", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.1358F, -0.3535F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -8.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r242 = underdividers.addChild("cube_r242", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.0892F, -1.949F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -8.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

        ModelPartData cube_r243 = underdividers.addChild("cube_r243", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -53.0892F, -1.949F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -3.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

        ModelPartData cube_r244 = underdividers.addChild("cube_r244", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -53.1358F, -0.3535F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -3.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r245 = underdividers.addChild("cube_r245", ModelPartBuilder.create().uv(11, 8).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-4.4408F, 0.0F, 2.5639F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r246 = underdividers.addChild("cube_r246", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(2.0128F, -19.0122F, 5.5155F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, -1.0036F, 0.0F, 0.0F));

        ModelPartData cube_r247 = underdividers.addChild("cube_r247", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(-3.0128F, -19.0122F, 5.5155F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, 2.138F, 1.0472F, 3.1416F));

        ModelPartData cube_r248 = underdividers.addChild("cube_r248", ModelPartBuilder.create().uv(0, 30).cuboid(-0.5F, -2.5392F, -2.949F, 1.0F, 8.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -4.4608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

        ModelPartData cube_r249 = underdividers.addChild("cube_r249", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(-0.5F, -15.3414F, 3.177F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, 2.138F, -1.0472F, 3.1416F));

        ModelPartData cube_r250 = underdividers.addChild("cube_r250", ModelPartBuilder.create().uv(0, 30).cuboid(-0.5F, -2.5858F, -1.3535F, 1.0F, 8.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -4.4142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

        ModelPartData cube_r251 = underdividers.addChild("cube_r251", ModelPartBuilder.create().uv(11, 8).mirrored().cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(4.4408F, 0.0F, 2.5639F, 0.0F, -2.0944F, 0.0F));
        ...
        ModelPartData cube_r252 = top.addChild("cube_r252", ModelPartBuilder.create().uv(57, 77).cuboid(-6.372F, -66.7F, -6.0313F, 11.0F, 0.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(-1.274F, 77.9621F, 0.7218F, 0.0F, -1.0472F, 0.0F));
        ...
        ModelPartData cube_r254 = top.addChild("cube_r254", ModelPartBuilder.create().uv(15, 18).cuboid(-3.0F, -1.25F, -5.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r255 = top.addChild("cube_r255", ModelPartBuilder.create().uv(15, 18).cuboid(-3.0F, -1.25F, 4.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r256 = top.addChild("cube_r256", ModelPartBuilder.create().uv(15, 18).cuboid(-3.5F, -0.75F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
                .uv(15, 18).cuboid(-3.5F, 3.95F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
                .uv(15, 18).cuboid(-3.5F, 6.95F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
                .uv(15, 18).cuboid(-3.5F, 5.45F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
                .uv(15, 18).cuboid(-3.5F, 14.1F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r257 = top.addChild("cube_r257", ModelPartBuilder.create().uv(15, 18).mirrored().cuboid(-4.0F, -1.25F, -5.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r258 = top.addChild("cube_r258", ModelPartBuilder.create().uv(15, 18).mirrored().cuboid(-4.0F, -1.25F, 4.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r259 = top.addChild("cube_r259", ModelPartBuilder.create().uv(34, 20).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r260 = top.addChild("cube_r260", ModelPartBuilder.create().uv(31, 17).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 7.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r261 = top.addChild("cube_r261", ModelPartBuilder.create().uv(34, 20).mirrored().cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r262 = top.addChild("cube_r262", ModelPartBuilder.create().uv(34, 20).cuboid(-3.0F, -2.25F, -2.0F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
                .uv(34, 21).cuboid(-3.0F, 2.75F, -2.0F, 6.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-0.384F, -3.5F, 2.3971F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r263 = top.addChild("cube_r263", ModelPartBuilder.create().uv(34, 20).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
                .uv(34, 21).cuboid(-2.5F, 2.75F, -4.3301F, 6.0F, 4.0F, 4.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r264 = top.addChild("cube_r264", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r265 = top.addChild("cube_r265", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r266 = top.addChild("cube_r266", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(29, 56).mirrored().cuboid(0.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(29, 56).mirrored().cuboid(0.9849F, 0.9849F, -6.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r267 = top.addChild("cube_r267", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r268 = top.addChild("cube_r268", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r269 = top.addChild("cube_r269", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r270 = top.addChild("cube_r270", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r271 = top.addChild("cube_r271", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.4474F, 7.0F, -0.7624F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r272 = top.addChild("cube_r272", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.4474F, 7.0F, -0.8356F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r273 = top.addChild("cube_r273", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -0.5F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.384F, 7.0F, 4.6899F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r274 = top.addChild("cube_r274", ModelPartBuilder.create().uv(25, 0).mirrored().cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)).mirrored(false), ModelTransform.of(-0.3206F, 7.0F, -0.8356F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r275 = top.addChild("cube_r275", ModelPartBuilder.create().uv(25, 0).mirrored().cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)).mirrored(false), ModelTransform.of(-0.3206F, 7.0F, -0.7624F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r276 = top.addChild("cube_r276", ModelPartBuilder.create().uv(15, 19).mirrored().cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(-0.4474F, 4.7F, -0.8356F, 0.0F, 1.0472F, 0.0F));

        ModelPartData cube_r277 = top.addChild("cube_r277", ModelPartBuilder.create().uv(15, 19).mirrored().cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(-0.4474F, 4.7F, -0.7624F, 0.0F, 2.0944F, 0.0F));

        ModelPartData cube_r278 = top.addChild("cube_r278", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.384F, 4.7F, -0.7258F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r279 = top.addChild("cube_r279", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.3206F, 4.7F, -0.7624F, 0.0F, -2.0944F, 0.0F));

        ModelPartData cube_r280 = top.addChild("cube_r280", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.3206F, 4.7F, -0.8356F, 0.0F, -1.0472F, 0.0F));

        ModelPartData cube_r281 = top.addChild("cube_r281", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9142F, 0.9142F, 4.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r282 = top.addChild("cube_r282", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9142F, 0.9142F, 4.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(29, 56).cuboid(-0.5F, -0.5F, 4.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(29, 56).cuboid(0.9142F, -1.9142F, 4.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(29, 56).cuboid(0.9142F, -1.9142F, -5.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(29, 56).cuboid(-0.5F, -0.5F, -5.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r283 = top.addChild("cube_r283", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r284 = top.addChild("cube_r284", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r285 = top.addChild("cube_r285", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r286 = top.addChild("cube_r286", ModelPartBuilder.create().uv(0, 18).cuboid(-3.0F, -2.0F, -0.5F, 6.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.384F, 9.7F, 3.8971F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData cube_r287 = bone.addChild("cube_r287", ModelPartBuilder.create().uv(4, 30).mirrored().cuboid(4.7375F, -0.0412F, -0.7948F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData cube_r288 = bone.addChild("cube_r288", ModelPartBuilder.create().uv(31, 20).cuboid(-4.5375F, -0.0412F, -1.9052F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r289 = flick4.addChild("cube_r289", ModelPartBuilder.create().uv(24, 38).cuboid(-1.7125F, -1.2412F, -1.3948F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, -0.5F, 1.25F, 0.6109F, 0.0F, 0.0F));

        ModelPartData flick2 = bone.addChild("flick2", ModelPartBuilder.create(), ModelTransform.of(-0.5F, 0.5F, -1.25F, 0.9163F, 0.0F, 0.0F));

        ModelPartData cube_r290 = flick2.addChild("cube_r290", ModelPartBuilder.create().uv(24, 38).cuboid(-1.7125F, -1.2412F, -1.3948F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, -0.5F, 1.25F, 0.6109F, 0.0F, 0.0F));

        ModelPartData flick3 = bone.addChild("flick3", ModelPartBuilder.create(), ModelTransform.of(0.5F, 0.5F, -1.25F, 0.9163F, 0.0F, 0.0F));

        ModelPartData cube_r291 = flick3.addChild("cube_r291", ModelPartBuilder.create().uv(24, 38).cuboid(-1.7125F, -1.2412F, -1.3948F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, -0.5F, 1.25F, 0.6109F, 0.0F, 0.0F));

        ModelPartData flick5 = bone.addChild("flick5", ModelPartBuilder.create(), ModelTransform.of(1.5F, 0.5F, -1.25F, 0.9163F, 0.0F, 0.0F));

        ModelPartData cube_r292 = flick5.addChild("cube_r292", ModelPartBuilder.create().uv(24, 38).cuboid(-1.7125F, -1.2412F, -1.3948F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, -0.5F, 1.25F, 0.6109F, 0.0F, 0.0F));

        ModelPartData lighton3 = bone.addChild("lighton3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r293 = lighton3.addChild("cube_r293", ModelPartBuilder.create().uv(15, 39).cuboid(0.9375F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData off4 = lighton3.addChild("off4", ModelPartBuilder.create(), ModelTransform.pivot(2.8F, 1.0F, 0.0F));

        ModelPartData cube_r294 = off4.addChild("cube_r294", ModelPartBuilder.create().uv(38, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData lighton2 = bone.addChild("lighton2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r295 = lighton2.addChild("cube_r295", ModelPartBuilder.create().uv(15, 39).cuboid(-0.4625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData off3 = lighton2.addChild("off3", ModelPartBuilder.create(), ModelTransform.pivot(1.4F, 1.0F, 0.0F));

        ModelPartData cube_r296 = off3.addChild("cube_r296", ModelPartBuilder.create().uv(38, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData lighton = bone.addChild("lighton", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData cube_r297 = lighton.addChild("cube_r297", ModelPartBuilder.create().uv(9, 14).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

        ModelPartData off2 = lighton.addChild("off2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.0F, 0.0F));

        ModelPartData cube_r298 = off2.addChild("cube_r298", ModelPartBuilder.create().uv(22, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r299 = bone15.addChild("cube_r299", ModelPartBuilder.create().uv(50, 21).cuboid(0.4939F, -2.0403F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.251F))
        ...
        ModelPartData cube_r300 = bone15.addChild("cube_r300", ModelPartBuilder.create().uv(18, 48).cuboid(0.3491F, -0.901F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 1.2103F, -0.2319F, -0.8878F));

        ModelPartData cube_r301 = bone15.addChild("cube_r301", ModelPartBuilder.create().uv(34, 17).cuboid(0.6383F, -0.1859F, -0.3538F, 1.0F, 2.0F, 1.0F, new Dilation(-0.251F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 1.061F, -0.7904F, -0.5961F));

        ModelPartData cube_r302 = bone15.addChild("cube_r302", ModelPartBuilder.create().uv(31, 50).cuboid(1.1679F, 0.5804F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 0.6413F, -1.128F, -0.094F));
        ...
        ModelPartData cube_r303 = toolbox.addChild("cube_r303", ModelPartBuilder.create().uv(18, 43).cuboid(0.0F, -1.087F, -1.1637F, 0.0F, 3.0F, 1.0F, new Dilation(0.002F))
        ...
        ModelPartData cube_r304 = toolbox.addChild("cube_r304", ModelPartBuilder.create().uv(15, 7).cuboid(0.0F, -2.1637F, -0.913F, 0.0F, 3.0F, 1.0F, new Dilation(0.002F))
        ...
        ModelPartData cube_r305 = lid.addChild("cube_r305", ModelPartBuilder.create().uv(15, 11).cuboid(-3.0F, -1.5892F, -2.0142F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r306 = lid2.addChild("cube_r306", ModelPartBuilder.create().uv(15, 11).cuboid(-2.0F, -1.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.2318F, -0.8889F, -2.3562F, 0.0F, 0.0F));

        ModelPartData cube_r307 = lid2.addChild("cube_r307", ModelPartBuilder.create().uv(23, 2).cuboid(1.0F, -0.5868F, 1.0153F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r308 = bone17.addChild("cube_r308", ModelPartBuilder.create().uv(112, 74).cuboid(-3.0F, -1.0F, 0.0F, 3.0F, 2.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.3F, -0.2508F, -0.0114F, 3.1378F, -0.1139F, 3.1333F));
