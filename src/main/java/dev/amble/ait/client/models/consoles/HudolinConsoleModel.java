...
public class HudolinConsoleModel extends ConsoleModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r159 = bottom.addChild("cube_r159", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r160 = bottom.addChild("cube_r160", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r161 = bottom.addChild("cube_r161", ModelPartBuilder.create().uv(43, 77).cuboid(-2.5F, -8.0F, 0.5F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F))
				.uv(8, 85).cuboid(-2.5F, -8.0F, -0.5F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.083F, 3.819F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r162 = bottom.addChild("cube_r162", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r163 = bottom.addChild("cube_r163", ModelPartBuilder.create().uv(8, 85).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r164 = bottom.addChild("cube_r164", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 1.1829F, -3.0484F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r165 = bottom.addChild("cube_r165", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0634F, 1.1829F, 0.0255F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r166 = bottom.addChild("cube_r166", ModelPartBuilder.create().uv(10, 63).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(2.6304F, 1.1829F, -1.5298F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r167 = bottom.addChild("cube_r167", ModelPartBuilder.create().uv(10, 63).cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.0634F, 1.1829F, 0.0255F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r168 = bottom.addChild("cube_r168", ModelPartBuilder.create().uv(10, 63).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-2.6304F, 1.1829F, -1.5298F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r169 = bottom.addChild("cube_r169", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r170 = bottom.addChild("cube_r170", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -0.7854F, 0.0F));
		...
		ModelPartData cube_r172 = bottom.addChild("cube_r172", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r173 = bottom.addChild("cube_r173", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.7854F, 3.1416F));

		ModelPartData cube_r174 = bottom.addChild("cube_r174", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.0F, 3.1416F));

		ModelPartData cube_r175 = bottom.addChild("cube_r175", ModelPartBuilder.create().uv(0, 73).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, -0.7854F, 3.1416F));
		...
		ModelPartData cube_r181 = top2.addChild("cube_r181", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, -1.5708F, 3.1416F));

		ModelPartData cube_r182 = top2.addChild("cube_r182", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, -3.1416F, -0.7854F, 0.0F));

		ModelPartData cube_r183 = top2.addChild("cube_r183", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, -3.1416F, 0.0F, 0.0F));

		ModelPartData cube_r184 = top2.addChild("cube_r184", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, -3.1416F, 0.7854F, 0.0F));

		ModelPartData cube_r185 = top2.addChild("cube_r185", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 1.5708F, -3.1416F));

		ModelPartData cube_r186 = top2.addChild("cube_r186", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 0.7854F, 3.1416F));

		ModelPartData cube_r187 = top2.addChild("cube_r187", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 3.1416F));

		ModelPartData cube_r188 = top2.addChild("cube_r188", ModelPartBuilder.create().uv(4, 73).cuboid(-0.5F, -8.0F, 2.6213F, 1.0F, 17.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.5F, 0.0F, 0.0F, -0.7854F, 3.1416F));
		...
		ModelPartData cube_r189 = nature.addChild("cube_r189", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r190 = nature.addChild("cube_r190", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r191 = nature.addChild("cube_r191", ModelPartBuilder.create().uv(43, 93).cuboid(-2.5F, -8.0F, 0.5F, 5.0F, 0.0F, 6.0F, new Dilation(0.0F))
				.uv(8, 101).cuboid(-2.5F, -8.0F, -0.5F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.083F, 3.819F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r192 = nature.addChild("cube_r192", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r193 = nature.addChild("cube_r193", ModelPartBuilder.create().uv(8, 101).cuboid(-2.5F, -10.5F, -4.3301F, 5.0F, 16.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.583F, -0.0111F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r194 = nature.addChild("cube_r194", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0F, 1.1829F, -3.0484F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r195 = nature.addChild("cube_r195", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(0.0634F, 1.1829F, 0.0255F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r196 = nature.addChild("cube_r196", ModelPartBuilder.create().uv(7, 121).mirrored().cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(2.6304F, 1.1829F, -1.5298F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r197 = nature.addChild("cube_r197", ModelPartBuilder.create().uv(7, 121).cuboid(-2.0F, -0.5F, 2.4641F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.0634F, 1.1829F, 0.0255F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r198 = nature.addChild("cube_r198", ModelPartBuilder.create().uv(7, 121).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-2.6304F, 1.1829F, -1.5298F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r199 = nature.addChild("cube_r199", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r200 = nature.addChild("cube_r200", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, -0.7854F, 0.0F));
		...
		ModelPartData cube_r202 = nature.addChild("cube_r202", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r203 = nature.addChild("cube_r203", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.7854F, 3.1416F));

		ModelPartData cube_r204 = nature.addChild("cube_r204", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, 0.0F, 3.1416F));

		ModelPartData cube_r205 = nature.addChild("cube_r205", ModelPartBuilder.create().uv(1, 101).cuboid(-0.5F, -7.5F, 2.6213F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.6829F, -0.0111F, -3.1416F, -0.7854F, 3.1416F));
		...
		ModelPartData cube_r206 = underdividers.addChild("cube_r206", ModelPartBuilder.create().uv(0, 23).mirrored().cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(8.0849F, 1.2922F, 4.6678F, 1.2654F, -1.0472F, 3.1416F));

		ModelPartData cube_r207 = underdividers.addChild("cube_r207", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-1.0F, 1.2562F, -3.0287F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(8.602F, 0.5234F, 4.9664F, 1.8762F, 1.0472F, 0.0F));

		ModelPartData cube_r208 = underdividers.addChild("cube_r208", ModelPartBuilder.create().uv(21, 0).mirrored().cuboid(-0.5F, -1.0522F, -0.8966F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(8.4618F, 1.8688F, 4.8854F, 1.7017F, -1.0472F, -3.1416F));

		ModelPartData cube_r209 = underdividers.addChild("cube_r209", ModelPartBuilder.create().uv(12, 2).mirrored().cuboid(-0.5F, -4.3012F, -0.2325F, 1.0F, 4.0F, 1.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(8.0849F, 1.2922F, 4.6678F, 2.0508F, -1.0472F, 3.1416F));

		ModelPartData cube_r210 = underdividers.addChild("cube_r210", ModelPartBuilder.create().uv(0, 13).cuboid(-1.0F, 1.4066F, 0.5519F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.0234F, -9.9328F, -1.8762F, 0.0F, 0.0F));

		ModelPartData cube_r211 = underdividers.addChild("cube_r211", ModelPartBuilder.create().uv(0, 23).cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 1.2922F, -9.3356F, -1.8762F, 0.0F, 0.0F));

		ModelPartData cube_r212 = underdividers.addChild("cube_r212", ModelPartBuilder.create().uv(21, 0).cuboid(-0.5F, -1.1025F, -0.0372F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.0234F, -9.9328F, -1.4399F, 0.0F, 0.0F));

		ModelPartData cube_r213 = underdividers.addChild("cube_r213", ModelPartBuilder.create().uv(12, 2).cuboid(-0.5F, -4.3012F, -0.2325F, 1.0F, 4.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 1.2922F, -9.3356F, -1.0908F, 0.0F, 0.0F));

		ModelPartData cube_r214 = underdividers.addChild("cube_r214", ModelPartBuilder.create().uv(0, 13).cuboid(-1.0F, -0.0301F, -2.3954F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-9.8294F, 0.7406F, 5.675F, 1.8762F, -1.0472F, 0.0F));

		ModelPartData cube_r215 = underdividers.addChild("cube_r215", ModelPartBuilder.create().uv(0, 23).cuboid(-0.5F, 1.0569F, 0.175F, 1.0F, 2.0F, 1.0F, new Dilation(-0.001F)), ModelTransform.of(-8.0849F, 1.2922F, 4.6678F, 1.2654F, 1.0472F, -3.1416F));

		ModelPartData cube_r216 = underdividers.addChild("cube_r216", ModelPartBuilder.create().uv(21, 0).cuboid(-0.5F, -1.0522F, -0.8966F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-8.4618F, 1.8688F, 4.8854F, 1.7017F, 1.0472F, -3.1416F));

		ModelPartData cube_r217 = underdividers.addChild("cube_r217", ModelPartBuilder.create().uv(12, 2).mirrored().cuboid(-0.5F, -4.3012F, -0.2325F, 1.0F, 4.0F, 1.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-8.0849F, 1.2922F, 4.6678F, 2.0508F, 1.0472F, -3.1416F));

		ModelPartData cube_r218 = underdividers.addChild("cube_r218", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.1358F, -0.3535F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-5.18F, -9.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r219 = underdividers.addChild("cube_r219", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -56.55F, 5.6278F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F))
		...
		ModelPartData cube_r220 = underdividers.addChild("cube_r220", ModelPartBuilder.create().uv(22, 23).mirrored().cuboid(-0.5F, -2.05F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)).mirrored(false)
		...
		ModelPartData cube_r221 = underdividers.addChild("cube_r221", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.0892F, -1.949F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(6.5616F, -9.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

		ModelPartData cube_r222 = underdividers.addChild("cube_r222", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -57.45F, 5.4301F, 1.0F, 2.0F, 1.0F, new Dilation(0.1F))
		...
		ModelPartData cube_r223 = underdividers.addChild("cube_r223", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.1358F, -0.3535F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -8.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r224 = underdividers.addChild("cube_r224", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -52.0892F, -1.949F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -8.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

		ModelPartData cube_r225 = underdividers.addChild("cube_r225", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -53.0892F, -1.949F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -3.3608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

		ModelPartData cube_r226 = underdividers.addChild("cube_r226", ModelPartBuilder.create().uv(22, 23).cuboid(-0.5F, -53.1358F, -0.3535F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -3.3142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r227 = underdividers.addChild("cube_r227", ModelPartBuilder.create().uv(11, 8).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-4.4408F, 0.0F, 2.5639F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r228 = underdividers.addChild("cube_r228", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(2.0128F, -19.0122F, 5.5155F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, -1.0036F, 0.0F, 0.0F));

		ModelPartData cube_r229 = underdividers.addChild("cube_r229", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(-3.0128F, -19.0122F, 5.5155F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, 2.138F, 1.0472F, 3.1416F));

		ModelPartData cube_r230 = underdividers.addChild("cube_r230", ModelPartBuilder.create().uv(0, 30).cuboid(-0.5F, -2.5392F, -2.949F, 1.0F, 8.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(6.5616F, -4.4608F, -3.7884F, -3.1416F, 1.0472F, 3.1416F));

		ModelPartData cube_r231 = underdividers.addChild("cube_r231", ModelPartBuilder.create().uv(10, 40).mirrored().cuboid(-0.5F, -15.3414F, 3.177F, 1.0F, 16.0F, 3.0F, new Dilation(-0.001F)).mirrored(false), ModelTransform.of(-2.5128F, -5.9648F, -1.4508F, 2.138F, -1.0472F, 3.1416F));

		ModelPartData cube_r232 = underdividers.addChild("cube_r232", ModelPartBuilder.create().uv(0, 30).cuboid(-0.5F, -2.5858F, -1.3535F, 1.0F, 8.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.18F, -4.4142F, -2.9907F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r233 = underdividers.addChild("cube_r233", ModelPartBuilder.create().uv(11, 8).mirrored().cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(4.4408F, 0.0F, 2.5639F, 0.0F, -2.0944F, 0.0F));
		...
		ModelPartData cube_r234 = top.addChild("cube_r234", ModelPartBuilder.create().uv(57, 77).cuboid(-6.372F, -66.7F, -6.0313F, 11.0F, 0.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(-1.274F, 77.9621F, 0.7218F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r235 = top.addChild("cube_r235", ModelPartBuilder.create().uv(15, 18).cuboid(-3.5F, -0.75F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r236 = top.addChild("cube_r236", ModelPartBuilder.create().uv(15, 18).cuboid(-3.0F, -1.25F, -5.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r237 = top.addChild("cube_r237", ModelPartBuilder.create().uv(15, 18).cuboid(-3.0F, -1.25F, 4.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r238 = top.addChild("cube_r238", ModelPartBuilder.create().uv(15, 18).cuboid(-3.5F, -0.75F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
				.uv(15, 18).cuboid(-3.5F, 3.95F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
				.uv(15, 18).cuboid(-3.5F, 6.95F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
				.uv(15, 18).cuboid(-3.5F, 5.45F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
				.uv(15, 18).cuboid(-3.5F, 14.1F, -0.5F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r239 = top.addChild("cube_r239", ModelPartBuilder.create().uv(15, 18).mirrored().cuboid(-4.0F, -1.25F, -5.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r240 = top.addChild("cube_r240", ModelPartBuilder.create().uv(15, 18).mirrored().cuboid(-4.0F, -1.25F, 4.3301F, 7.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r241 = top.addChild("cube_r241", ModelPartBuilder.create().uv(34, 20).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r242 = top.addChild("cube_r242", ModelPartBuilder.create().uv(31, 17).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 7.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r243 = top.addChild("cube_r243", ModelPartBuilder.create().uv(34, 20).mirrored().cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r244 = top.addChild("cube_r244", ModelPartBuilder.create().uv(34, 20).cuboid(-3.0F, -2.25F, -2.0F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
				.uv(34, 21).cuboid(-3.0F, 2.75F, -2.0F, 6.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-0.384F, -3.5F, 2.3971F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r245 = top.addChild("cube_r245", ModelPartBuilder.create().uv(34, 20).cuboid(-2.5F, -2.25F, -4.3301F, 6.0F, 5.0F, 4.0F, new Dilation(0.0F))
				.uv(34, 21).cuboid(-2.5F, 2.75F, -4.3301F, 6.0F, 4.0F, 4.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r246 = top.addChild("cube_r246", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r247 = top.addChild("cube_r247", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r248 = top.addChild("cube_r248", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
				.uv(29, 56).mirrored().cuboid(0.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
				.uv(29, 56).mirrored().cuboid(0.9849F, 0.9849F, -6.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r249 = top.addChild("cube_r249", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9849F, 0.9849F, 5.289F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r250 = top.addChild("cube_r250", ModelPartBuilder.create().uv(29, 56).mirrored().cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r252 = top.addChild("cube_r252", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r253 = top.addChild("cube_r253", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.4474F, 7.0F, -0.7624F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r254 = top.addChild("cube_r254", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.4474F, 7.0F, -0.8356F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r255 = top.addChild("cube_r255", ModelPartBuilder.create().uv(25, 0).cuboid(-3.5F, -1.0F, -0.5F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)), ModelTransform.of(-0.384F, 7.0F, 4.6899F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r256 = top.addChild("cube_r256", ModelPartBuilder.create().uv(25, 0).mirrored().cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)).mirrored(false), ModelTransform.of(-0.3206F, 7.0F, -0.8356F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r257 = top.addChild("cube_r257", ModelPartBuilder.create().uv(25, 0).mirrored().cuboid(-3.5F, -1.0F, -6.0622F, 7.0F, 2.0F, 1.0F, new Dilation(-0.1F)).mirrored(false), ModelTransform.of(-0.3206F, 7.0F, -0.7624F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r258 = top.addChild("cube_r258", ModelPartBuilder.create().uv(15, 19).mirrored().cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(-0.4474F, 4.7F, -0.8356F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r259 = top.addChild("cube_r259", ModelPartBuilder.create().uv(15, 19).mirrored().cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)).mirrored(false), ModelTransform.of(-0.4474F, 4.7F, -0.7624F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r260 = top.addChild("cube_r260", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.384F, 4.7F, -0.7258F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r261 = top.addChild("cube_r261", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.3206F, 4.7F, -0.7624F, 0.0F, -2.0944F, 0.0F));

		ModelPartData cube_r262 = top.addChild("cube_r262", ModelPartBuilder.create().uv(15, 19).cuboid(-3.5F, -1.5F, -6.0622F, 7.0F, 3.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(-0.3206F, 4.7F, -0.8356F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r263 = top.addChild("cube_r263", ModelPartBuilder.create().uv(29, 56).cuboid(-1.9142F, 0.9142F, 4.5961F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r265 = top.addChild("cube_r265", ModelPartBuilder.create().uv(29, 56).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r268 = top.addChild("cube_r268", ModelPartBuilder.create().uv(0, 18).cuboid(-3.0F, -2.0F, -0.5F, 6.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.384F, 9.7F, 3.8971F, 0.0F, 3.1416F, 0.0F));
		...
		ModelPartData cube_r269 = bone.addChild("cube_r269", ModelPartBuilder.create().uv(4, 30).mirrored().cuboid(4.7375F, -0.0412F, -0.7948F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
		...
		ModelPartData cube_r270 = bone.addChild("cube_r270", ModelPartBuilder.create().uv(31, 20).cuboid(-4.5375F, -0.0412F, -1.9052F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r271 = lighton3.addChild("cube_r271", ModelPartBuilder.create().uv(15, 39).cuboid(0.9375F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		ModelPartData off4 = lighton3.addChild("off4", ModelPartBuilder.create(), ModelTransform.pivot(2.8F, 1.0F, 0.0F));

		ModelPartData cube_r272 = off4.addChild("cube_r272", ModelPartBuilder.create().uv(38, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		ModelPartData lighton2 = bone.addChild("lighton2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r273 = lighton2.addChild("cube_r273", ModelPartBuilder.create().uv(15, 39).cuboid(-0.4625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		ModelPartData off3 = lighton2.addChild("off3", ModelPartBuilder.create(), ModelTransform.pivot(1.4F, 1.0F, 0.0F));

		ModelPartData cube_r274 = off3.addChild("cube_r274", ModelPartBuilder.create().uv(38, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		ModelPartData lighton = bone.addChild("lighton", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r275 = lighton.addChild("cube_r275", ModelPartBuilder.create().uv(9, 14).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.04F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		ModelPartData off2 = lighton.addChild("off2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.0F, 0.0F));

		ModelPartData cube_r276 = off2.addChild("cube_r276", ModelPartBuilder.create().uv(22, 71).cuboid(-1.8625F, -0.4412F, -0.5948F, 1.0F, 1.0F, 1.0F, new Dilation(-0.03F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
		...
		ModelPartData cube_r277 = bone15.addChild("cube_r277", ModelPartBuilder.create().uv(50, 21).cuboid(0.4939F, -2.0403F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.251F))
		...
		ModelPartData cube_r278 = bone15.addChild("cube_r278", ModelPartBuilder.create().uv(18, 48).cuboid(0.3491F, -0.901F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 1.2103F, -0.2319F, -0.8878F));

		ModelPartData cube_r279 = bone15.addChild("cube_r279", ModelPartBuilder.create().uv(34, 17).cuboid(0.6383F, -0.1859F, -0.3538F, 1.0F, 2.0F, 1.0F, new Dilation(-0.251F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 1.061F, -0.7904F, -0.5961F));

		ModelPartData cube_r280 = bone15.addChild("cube_r280", ModelPartBuilder.create().uv(31, 50).cuboid(1.1679F, 0.5804F, -0.3528F, 1.0F, 2.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, -1.25F, -2.0F, 0.6413F, -1.128F, -0.094F));
		...
		ModelPartData cube_r281 = toolbox.addChild("cube_r281", ModelPartBuilder.create().uv(18, 43).cuboid(0.0F, -1.087F, -1.1637F, 0.0F, 3.0F, 1.0F, new Dilation(0.002F))
		...
		ModelPartData cube_r282 = toolbox.addChild("cube_r282", ModelPartBuilder.create().uv(15, 7).cuboid(0.0F, -2.1637F, -0.913F, 0.0F, 3.0F, 1.0F, new Dilation(0.002F))
		...
		ModelPartData cube_r283 = lid2.addChild("cube_r283", ModelPartBuilder.create().uv(15, 11).cuboid(-2.0F, -1.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -0.2318F, -0.8889F, -2.3562F, 0.0F, 0.0F));

		ModelPartData cube_r284 = lid2.addChild("cube_r284", ModelPartBuilder.create().uv(23, 2).cuboid(1.0F, -0.5868F, 1.0153F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r285 = lid.addChild("cube_r285", ModelPartBuilder.create().uv(15, 11).cuboid(-3.0F, -1.5892F, -2.0142F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r286 = bone17.addChild("cube_r286", ModelPartBuilder.create().uv(112, 74).cuboid(-3.0F, -1.0F, 0.0F, 3.0F, 2.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(2.3F, -0.2508F, -0.0114F, 3.1378F, -0.1139F, 3.1333F));
